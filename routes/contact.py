    ...
    logo_block = (
        f"""
                <div style="text-align:center;">
                  <img src="{logo_url_escaped}" alt="PSI Book Store" style="width:120px;max-width:120px;height:auto;display:inline-block;margin-bottom:15px;" />
                </div>
"""
        if logo_url_escaped
        else ""
            ...
            <tr>
              <td style="padding:6px 24px 18px 24px;font-family:Arial,Helvetica,sans-serif;color:#111827;">
                <div style="text-align:center;font-size:14px;line-height:1.6;color:#374151;">
                  ...
                  Thanks for contacting PSI Book Store. We will respond shortly.
                </div>
              </td>
            </tr>
            <tr>
